...
import org.trivaris.tasks.view.components.registerForm

fun HTML.register(initialLoginResult: AuthController.LoginResult) {
    head { loadTailwind() }
    body {
        ...
        div {
            ...
            h2 {
                ...
                +"Register for TaskTracker"
            }
            registerForm(initialLoginResult)
        }
    }
}